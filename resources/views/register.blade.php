...
<body>
    ...
    <div class="container main">
        ...
        <div class="login-box my-5">
            <h3 class="text-center mb-4">Selamat Datang di <br><strong>e-rentBook</strong> 👋</h3>
            <p class="text-center mb-4">Silahkan sign up untuk melanjutkan.</p>
